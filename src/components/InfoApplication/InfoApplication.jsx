  ...
  return (
    ...
    candidate && (
      ...
      {page === "normal" && <Box
        ...
        >
          <Typography variant="h5">Date: {application.dateTime.slice(0,10)}</Typography>
          <em>{application.company_Status}</em>
        </Box>} 
                    ...
                    >
                      ...
                      <Box sx={{ display: "flex", flexDirection: "row" }}>
                        ...
                        >
                          <Box sx={gridSx}>
                            <ZoomIn />
                            <Typography variant="h6">Max Hiring</Typography>
                          </Box>
                        </Grid>
                        <Grid
                          item
                      ...
                      <Box sx={{ display: "flex", flexDirection: "row" }}>
                        ...
                        <Grid item md={right} sx={gridSx}>
                          <Chip
                            variant="outlined"
                            color="info"
                            sx={{ display: "flex", margin: "0px 0px 5px 8px" }}
