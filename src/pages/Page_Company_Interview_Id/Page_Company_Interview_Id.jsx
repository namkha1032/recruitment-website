        ...
        <>
          ...
          >
            <Button
              variant="contained"
              color="primary"
              sx={{ fontSize: 25, borderRadius: 100 }}
            >
          ...
          <Grid container spacing={4}>
            <Grid item md={6} xs={12}>
              <GigaCard>
                <GigaCardHeader
                  color={"primary.main"}
                  headerIcon={<EditNoteIcon sx={{ fontSize: "inherit" }} />}
                >
                  Note
                </GigaCardHeader>
                <GigaCardBody>
            ...
            <Grid item md={6} xs={12}>
              <GigaCard>
                <GigaCardHeader
                  color={"primary.main"}
                  headerIcon={<QuestionMarkIcon sx={{ fontSize: "inherit" }} />}
                >
                  Questions
                </GigaCardHeader>
                <GigaCardBody>
                ...
                <Grid container>
                  ...
                  >
                    <GigaCardHeader
                      color={"primary.main"}
                      headerIcon={
                        <TroubleshootIcon sx={{ fontSize: "inherit" }} />
                      }
                    >
                      Analysis
                    </GigaCardHeader>
                  ...
                  >
                    <GigaCardHeader
                      color={"primary.main"}
                      headerIcon={
                        <SportsScoreIcon sx={{ fontSize: "inherit" }} />
                      }
                    >
                      Final Score
                    </GigaCardHeader>
